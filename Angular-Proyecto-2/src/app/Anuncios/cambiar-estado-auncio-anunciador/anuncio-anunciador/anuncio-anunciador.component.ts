...
@Component({
  selector: 'app-anuncio-anunciador',
  standalone: true,
  imports: [],
  templateUrl: './anuncio-anunciador.component.html',
  styleUrl: './anuncio-anunciador.component.css'
})
export class AnuncioAnunciadorComponent {
  @Input({required: true})
  anuncio!: Anuncio;
